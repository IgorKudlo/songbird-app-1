      ...
      <div className="col-md-6">
        <ul className="item-list list-group">
          <li className="list-group-item">
            <span className="li-btn"/>Ворон
          </li>
          <li className="list-group-item">
            <span className="li-btn"/>Журавль
          </li>
          <li className="list-group-item">
            <span className="li-btn"/>Ласточка
          </li>
          <li className="list-group-item">
            <span className="li-btn"/>Козодой
          </li>
          <li className="list-group-item">
            <span className="li-btn"/>Кукушка
          </li>
          <li className="list-group-item">
            <span className="li-btn"/>Синица
          </li>
        </ul>
      </div>
      <div className="col-md-6">
